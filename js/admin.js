...
window.addEventListener("load", () => {
  ...
  async function initializeApp() {
    ...
    map.on("dragstart", () => {
      ...
      document.getElementById("follow-entregador-button")?.classList.remove("active");
    });
    document.getElementById("follow-entregador-button")?.addEventListener("click", handleToggleFollow);
